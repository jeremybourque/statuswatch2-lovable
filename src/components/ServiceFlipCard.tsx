      ...
      <div
        ...
        <div
          ...
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs font-medium font-mono text-muted-foreground">{backView === 'graph' ? <>page load time: <span className="text-foreground">{graphAvg !== null ? graphAvg.toFixed(2) : '—'}s</span></> : `${uptimePercent}% uptime`}</span>
          </div>
